...
export class DabDeviceInterface {
     ...
     * @param dabDeviceId Unique DAB Device ID to use for this DAB Device for all MQTT topics.
     *                    This is likely uniquely generated by the bridge, or user provided for debugging purposes.
     */
    constructor(dabDeviceId) {
        if (new.target === DabDeviceInterface) {
            throw new TypeError("Cannot construct DabDeviceInterface instances directly. " +
                "Please refer to README and inherit this class for your implementation.");
        }

        this.telemetry = {};

        if(!dabDeviceId)
            throw new Error(`Failed to create DAB Device Interface: dabDeviceId value of ${dabDeviceId} cannot be used!`);
        this.dabDeviceID = dabDeviceId;
    }
    ...
    async init(uri) {
        ...
        await Promise.all(
            [
                ...
                this.client.handle(`dab/${this.dabDeviceID}/${topics.SYSTEM_SETTING_GET}`, this.getSystemSettings),
                this.client.handle(`dab/${this.dabDeviceID}/${topics.SYSTEM_SETTING_SET}`, this.setSystemSettings),
                ...
                this.client.handle(`dab/${this.dabDeviceID}/${topics.APP_TELEMETRY_STOP_TOPIC}`, this.stopAppTelemetry),
